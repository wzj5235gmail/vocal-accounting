...
// 添加防抖，避免短时间内多次请求同一汇率
const pendingRequests: { [key: string]: Promise<number> | undefined } = {};
...
export async function getExchangeRate(
  ...
  try {
    ...
    pendingRequests[pendingRequestsKey] = new Promise(
 ...
 * @returns 转换后的总金额
 */
export async function convertExpensesToCurrency(
